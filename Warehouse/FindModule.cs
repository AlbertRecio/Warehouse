...
namespace Warehouse
{
    public partial class FindModule : Form
    {
        public FindModule()
        {
            InitializeComponent();
        ...
        public string ID;
        private void FindModule_Load(object sender, EventArgs e)
        {
            dt = new warehouseBusinessLayer().findModule();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ID = dataGridView2.Rows[num].Cells["moduleID"].Value.ToString();
            this.Close();
        }
