...
namespace Warehouse
{
    public partial class FindStockIn : Form
    {
        public FindStockIn()
        {
            InitializeComponent();
        ...
        public string ID;
        private void FindStockIn_Load(object sender, EventArgs e)
        {
            dt = new warehouseBusinessLayer().findStockIn();
        ...
        private void dataGridView2_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            ID = dataGridView2.Rows[num].Cells["receivingID"].Value.ToString();
            this.Close();
        }
